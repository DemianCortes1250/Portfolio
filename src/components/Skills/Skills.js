    ...
    return (
        <div>
            ...
            <div className="pb-8 pl-3 pr-2 mt-10 max-w-[550px] mx-auto grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8 justify-center">
                <div className="animate-fade-down animate-once animate-duration-[1000ms] animate-delay-50 animate-ease-linear animate-normal animate-fill-forwards p-4 md:p-8 border-Color2 border-solid border-2 w-full md:w-44">
