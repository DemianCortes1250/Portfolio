  ...
  return (
    <div>
      ...
      <div className=" flex flex-col items-center mt-20">
        <p className="animate-fade-down animate-once animate-duration-[2000ms] animate-delay-[10ms] animate-ease-linear animate-normal 
            animate-fill-forwards w-1/2 font-mono leading-normal tracking-normal antialiased fond-bold text-2xl text-orange-200">
        ...
        <div className="animate-fade-up animate-once animate-duration-[2000ms] animate-delay-[10ms] animate-ease-linear animate-normal
            animate-fill-forwards space-x-40 flex mt-4 pt-20">
